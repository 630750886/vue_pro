...
<!--      </div>-->
      <el-table
        ...
        <el-table-column prop="contractTypeName" label="合同类型" show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="contractCode" label="合同编号" v-show="150" align="center" width="150"></el-table-column>
        <el-table-column prop="contractName" label="合同名称" width="200" show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="projectCode" label="项目编号" width="150" align="center"></el-table-column>
        <el-table-column prop="projectName" label="项目名称" width="200" show-overflow-tooltip align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="projectMajorName" label="专业工程分类" width="120" align="center"></el-table-column>
        <el-table-column prop="projectTypeName" label="类型" width="100" align="center"></el-table-column>
        <el-table-column prop="groupWorks" label="工作组" width="80" align="center">
        ...
        <el-table-column prop="contactPerson" label="委托联系人" width="100" align="center">
          <template slot-scope="scope">
            <com-popover
        ...
        <el-table-column prop="outcomeDocument" label="成果文件" width="100" align="center">
          <template slot-scope="scope">
            <template
                v-if="
        ...
        <el-table-column prop="reportsSum" label="编制金额(元)" width="150" align="center"></el-table-column>
        <el-table-column prop="auditSignSum" label="审核金额(元)" width="150" align="center">
          <template slot-scope="scope">
...
<script>
  ...
  import downDialog from "../dialog/downDialogCost.vue";
  import fileNotesDialog from "../dialog/fileNotesDialogCost.vue";
  import ModifyFile from "../dialog/ModifyFileCost.vue";
