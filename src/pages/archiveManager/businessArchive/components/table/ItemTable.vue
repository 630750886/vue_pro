...
<!--      </div>-->
      <el-table
        ...
        <el-table-column prop="projectTypeName" label="类型" align="center" width="80"></el-table-column>
...
<!--          </template>-->
        ...
        <el-table-column prop="projectcontact" label="委托联系人" width="120" align="center">
          <template slot-scope="scope">
            <com-popover
...
<script>
  ...
  import downDialog from "../dialog/downDialogManager.vue";
  import fileNotesDialog from "../dialog/fileNotesDialogManager.vue";
  import ModifyFile from "../dialog/ModifyFileManager.vue";
  export default {
    components: {
      pagination,
      // TableButton,
