<template>
  <div class="body">
    <div class="column">
      <div class="card-main">
        <div class="button">
          <public-button name="XIN1JIAN" title="新建协议" icon="el-icon-plus" @click="$refs.addRef.openDialog()"></public-button>
        </div>
        <el-table :key="tableKey"
                  ...
                  border>
          <el-table-column prop="createddateTime" label="创建时间" width="110px"><template slot-scope="scope">{{scope.row.createddateTime|datefmt('YYYY/MM/DD')}}</template></el-table-column>
          <el-table-column prop="studyoutfile" label="附件" width="60px">
            <template slot-scope="scope">
              <download-button :value="scope.row.studyoutfile"></download-button>
            </template>
          </el-table-column>
          <el-table-column prop="changedesc" label="修改要求" width="260px"></el-table-column>
          <el-table-column prop="approvedate" label="审核完成时间" width="130px"></el-table-column>
          <el-table-column prop="concludesigndateTime" label="协议签订时间" width="130px"></el-table-column>
          <el-table-column prop="completefinalfile" label="盖章扫描件" width="120px">
            <template slot-scope="scope">
