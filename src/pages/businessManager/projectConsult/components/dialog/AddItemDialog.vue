...
export default {
  ...
  data() {
    return {
      dialogVisible: false,
      scontractType:["402880fa74c3492d0174d98785e3003d","402880fa74c3492d0174d9897c370042","402880fa74c3492d0174d989b38e0043"],//工程咨询合同
      form: {
        contractTypeCode: "",
        contractTypeName: "",
        contractKeyid: "",
        ...
        contractVocationalTypeCode:"TYPE-064"
      },
      formRules:{
  ...
  //生命周期函数节点 auto_projectname
  created() {
    if (this.session.getItem("auto_consult")==null)
      {
        this.getallcontract();
      }
  },
    ...
    getallcontract()
      {
          this.javaHttp("agr/busicontractbase/autofindofproject",{datatype:this.scontractType}).then(reqdata=>{
              ...
              this.session.setItem("auto_consult", this.selectcosume);
          });
    },
    querySearch(queryString, cb) {
        var restaurants=this.session.getItem("auto_consult");
