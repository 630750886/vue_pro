...
<!--				<el-form-item label="公示附件" prop="attachFile">-->
<!--          <upload-button v-model="form.attachFile"></upload-button>-->
<!--				</el-form-item>-->
<!--				<el-form-item label="需求相关附件" prop="needAttachFile">-->
<!--          <upload-button v-model="form.needAttachFile" message="主要包括：资格条件、技术参数商务需求、评分办法"></upload-button>-->
<!--				</el-form-item>-->
  ...
  export default {
    ...
    data() {
      return {
        ...
        formRules:{
          publicitydateTime:{ required: true, message: '请选择时间', trigger: 'change' },
          publicityWebName:{ required: true, message: '请输入网站名称',  trigger: 'change' },
          publicityImageFile:{ required: true, message: '请上传网站截图', trigger: 'change' },
          publicityCount:{ required: true, message: '请输入发布次数', trigger: 'blur' }
        },
