...
<!--    				<el-button type="text" @click="$refs.perfectRef.openDialog(scope.row)">完善发布信息</el-button>-->
		...
		<div class="dialog">
<!--			title="新增编制及发布"-->
			<add-single-release  width="30%" ref="addRef" @getFormData="networkAddData"></add-single-release>
<!--			title="异议处理登记"-->
...
<!--			<perfect-single-dialog title="完善发布信息" width="50%" ref="perfectRef"></perfect-single-dialog>-->
...
<script>
  ...
  import {getPretrial,addPretrial,upPretrial,delPretrial} from '../../../../../../../api/workbench/webapi-biddingAgency.js'
	import getWeb from "../dialog/SinglePublicityTable/getWeb.vue";
	import {GetHttp} from "../../../../../../../utils/http";
	import ObjectionHandlingDialog from "../dialog/PublishResultsTable/ObjectionHandlingDialog.vue"
  export default {
    components: {
      HeadRightButton,
			AddSingleRelease,
      ...
      networkGetDataList() {
        ...
        getPretrial(ref).then(item=>{
          this.dataList=item.data
					this.maxOrder=item.data.length
        })
      },
