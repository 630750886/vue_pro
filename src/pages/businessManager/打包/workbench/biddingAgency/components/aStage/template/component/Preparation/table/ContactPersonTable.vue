<template>
	...
	<div class="column">
		...
		<head-right-button :title="'新建'" @click="$refs.addContactsRef.openDialog()"></head-right-button>
		<el-table
						:data="itemContacts"
						style="width: 100%"
						align="center"
			...
			<el-table-column label="操作" align="center">
				<template slot-scope="scope">
					<el-button type="text" size="mini" @click="$refs.reviseContactsRef.openDialog(scope.row)">登记</el-button>
		...
		<div class="dialog">
<!--			title="联系人"-->
			<add-contacts-dialog ref="addContactsRef"  width="30%" @getFormData="submitAddContact"></add-contacts-dialog>
<!--			title="修改联系人"-->
			<add-contacts-dialog ref="reviseContactsRef"  width="30%" @getFormData="submitUpContact"></add-contacts-dialog>
		</div>
	</div>
