<template>
	<div class="column">
		<div class="btn">
			<head-right-button  @click="$refs.addMeansRef.openDialog()" title="新建"></head-right-button>
		</div>
		<el-table
						:data="materialList"
						style="width: 100%"
		...
		<div class="dialog">
<!--			 title="新增资料"-->
			<add-means-dialog ref="addMeansRef" width="30%" @getFormData="submitAddMeans"></add-means-dialog>
		</div>
	</div>
