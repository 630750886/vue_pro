...
export default {
  ...
  data() {
    return {
      dialogVisible: false,
      scontractType:["402880fa74c3492d0174d988b0cb003f","402880fa74c3492d0174d9897c370042","402880fa74c3492d0174d989b38e0043"],
      form: {
        contractTypeCode: "",
        contractTypeName: "",
        contractKeyid: "",
        ...
        contractVocationalTypeCode:"TYPE-082"
      },
      bidItemType:[],
      formRules: {
  ...
  //生命周期函数节点
  created() {
     if (this.session.getItem("auto_agency")==null)
      {
        this.getallcontract();
      }
  },
    ...
    getallcontract()
      {
          this.javaHttp("agr/busicontractbase/autofindofproject",{datatype:this.scontractType}).then(reqdata=>{
              ...
              this.session.setItem("auto_agency", this.selectcosume);
          });
    },
    querySearch(queryString, cb) {
        var restaurants=this.session.getItem("auto_agency");
