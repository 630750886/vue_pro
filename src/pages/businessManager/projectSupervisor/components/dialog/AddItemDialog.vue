...
<script>
  ...
  export default {
    ...
    data() {
      return {
        dialogVisible: false,
        scontractType:["402880fa74c3492d0174d988f7670040","402880fa74c3492d0174d9897c370042","402880fa74c3492d0174d989b38e0043"],
        form:{
          contractTypeCode: "",
        contractTypeName: "",
        contractKeyid: "",
        ...
        contractVocationalTypeCode:"TYPE-083"
        },
       formRules:{
    ...
    //生命周期函数节点
    created() {
     if (this.session.getItem("auto_supervicor")==null)
      {
        this.getallcontract();
      }
    },
    ...
    methods: {
      getallcontract()
      {
          this.javaHttp("agr/busicontractbase/autofindofproject",{datatype:this.scontractType}).then(reqdata=>{
              ...
              this.session.setItem("auto_supervicor", this.selectcosume);
          });
    },
    querySearch(queryString, cb) {
        var restaurants=this.session.getItem("auto_supervicor");
