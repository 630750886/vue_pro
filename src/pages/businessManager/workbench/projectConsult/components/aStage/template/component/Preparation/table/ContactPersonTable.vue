<template>
	<div class="column">
		<head-right-button title="新增" @click="$refs.addContactsRef.openDialog()"></head-right-button>
		<el-table
						:data="itemContacts"
						style="width: 100%"
						align="left"
			...
			<el-table-column v-if="isUnit" prop="enterprisename" label="单位名称"></el-table-column>
			<el-table-column prop="contactname" label="客户联系人" width="140"></el-table-column>
			<el-table-column prop="contactphone" label="联系人电话" width="120"></el-table-column>
			<el-table-column prop="contactdepartment" label="联系人部门" show-overflow-tooltip></el-table-column>
			<el-table-column prop="contactpost" label="联系人职务" width="120"></el-table-column>
		...
		<div class="dialog">
			<add-contacts-dialog ref="addContactsRef" title="" width="30%" @getFormData="submitAddContact"></add-contacts-dialog>
			<add-contacts-dialog ref="reviseContactsRef" title="" width="30%" @getFormData="submitUpContact"></add-contacts-dialog>
		</div>
	</div>
  ...
  export default {
    ...
    methods: {
      ...
      networkGetItemContacts() {
        let ref={
          contactTypeKeyId:this.contactType,//1代表委托联系人，2代表当事人双方联系人
