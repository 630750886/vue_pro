  ...
  <div class="body">
    ...
    <div class="table">
      <el-table ref="tableRef"
        ...
        <el-table-column prop="probeBookCode" :label="bookType.name+'书编号'" align="center" width="130"></el-table-column>
        <el-table-column prop="outPutdateTime" :label="bookType.name+'书出具时间'" align="center" width="130"></el-table-column>
