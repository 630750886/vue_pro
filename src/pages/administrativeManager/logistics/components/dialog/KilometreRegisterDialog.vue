  ...
  <div>
    <el-dialog :title="title" :visible.sync="dialogVisible"  v-if="dialogVisible" width="30%" @close="dialogClose()" :close-on-click-modal="false">
      <el-form :model="form" ref="formRef" :rules="formRules" label-width="90px">
        <el-form-item label="陪同师傅" prop="driveName" label-width="120px">
          <el-input v-model="form.driveName" clearable></el-input>
        </el-form-item>
        <el-form-item label="总公里数" prop="useVehicleRouteNum" label-width="120px">
          <el-input v-model="form.useVehicleRouteNum" clearable></el-input>
        </el-form-item>
      </el-form>
