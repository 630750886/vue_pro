...
import PreserveFileButton from "./button/PreserveFileButton.vue";
import PrimaryButton from "./button/PrimaryButton.vue";
import PublicButton from "./button/PublicButton.vue";
import ShowFileButon from "./button/ShowFileButon.vue";
import ShowInfoButton from "./button/ShowInfoButton.vue";
...
import WorkRemindButton from "./button/workRemind/index.vue";
...
Vue.component("preserve-button", PreserveFileButton);
Vue.component("primary-button", PrimaryButton);
Vue.component("public-button", PublicButton);
Vue.component("show-file-button", ShowFileButon);
Vue.component("show-info-button", ShowInfoButton);
...
Vue.component("work-remind-button", WorkRemindButton);
//复合型 composite
...
import QueryInputa from "./reassembly/aQueryInput.vue";
...
Vue.component("rea-query-inputa", QueryInputa);
